...
public class OptimUnit : MonoBehaviour
{
    ...
    void Update()
    {
        Profiler.BeginSample("Profiling HandleTime();");
        HandleTime();
        Profiler.EndSample();

        Profiler.BeginSample("Profiling Rotation");
        var t = transform;
        ...
        Profiler.BeginSample("Profiling Move();");
        Move();
        Profiler.EndSample();

        Profiler.BeginSample("Profiling Boundary");
